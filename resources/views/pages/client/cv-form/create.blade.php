<x-layout.app-layout>
    ...
    <div class="flex">
        <div class="h-screen overflow-y-auto flex-1 p-10">
            <form action="{{ route('client.cv-form.store') }}" method="POST" enctype="multipart/form-data"
                ...
                @if ($cvInfo = session('cv-info'))
                    <input name="form_id" type="hidden" value="{{ $cvInfo->id }}">
                @endif
                ...
                <div class="flex justify-end items-center">
                    <x-common.button.primary class="mt-3" type="submit">
                        Submit
                    </x-common.button.primary>
                </div>
            </form>
        </div>
        <div class="h-screen overflow-y-auto flex-1 hidden">
        ...
        <div class="h-screen overflow-y-auto flex-1" x-data>
            <div class="flex justify-center mt-10">
                <div class="max-w-[600px] w-full border shadow-lg">
                    <header class="bg-[#303745] flex min-h-[50px]">
                        <div class=" w-[80px] h-[80px] bg-cover bg-center bg-no-repeat" id="preview-cv-profile"
