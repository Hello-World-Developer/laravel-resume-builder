            ...
            <div class="border mt-4 p-4"
                ...
                <div class="">
                    <label class="text-md text-gray-500 inline-block mb-1"
                        for="language_name_{{ $id }}">
                        language
                    </label>
                    <input
                        onkeyup="handlelanguage(this)"
                        class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        id="language_name_{{ $id }}"
                ...
                <div class="flex mt-3">
                    <div class="flex-1">
                        ...
                        <div class="flex items-center w-full">
                            <input
                                onchange="handlelanguage(this)"
                                class="language-range flex-1 h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
                                id="language_range_{{ $id }}"
